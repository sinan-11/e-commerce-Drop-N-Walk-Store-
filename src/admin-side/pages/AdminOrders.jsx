...
const STATUS_STYLES = {
  "Placed": "bg-sky-50 text-sky-600 border-sky-200",
  "Shipped": "bg-violet-50 text-violet-600 border-violet-200",
  "Out for Delivery": "bg-amber-50 text-amber-600 border-amber-200",
...
const STATUS_BORDER = {
  ...
  "Out for Delivery": "border-l-amber-400",
  ...
  const updateStatus = (userId, orderId, status) => {
    axios.get(`http://localhost:5000/users/${userId}`)
      .then(res => {
        ...
        return axios.patch(`http://localhost:5000/users/${userId}`, {
