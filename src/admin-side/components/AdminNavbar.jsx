      ...
      <header className="max-w-7xl mx-auto bg-gray-50/90 backdrop-blur rounded-2xl shadow-xl border border-gray-200">
        ...
        <div className="px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gray-900 text-white flex items-center justify-center font-semibold shadow-sm">
              A
            </div>
        ...
        {open && (
          <div className="md:hidden px-6 pb-6 pt-3 space-y-2 border-t border-gray-200 bg-gray-50/90">
            ...
            <NavLink onClick={() => setOpen(false)} to="/admin/products" className={linkClass}>
              Products
            </NavLink>
            <NavLink onClick={() => setOpen(false)} to="/admin/orders" className={linkClass}>
              Orders
            </NavLink>
            <NavLink onClick={() => setOpen(false)} to="/admin/users" className={linkClass}>
              Users
            </NavLink>
